...
def plotNode(nodeTxt, centerPt, parentPt, nodeType):
    '''
    createPlot.ax1.annotate(str(nodeTxt, 'cp936'), xy=parentPt,
                            xycoords='axes fraction',
                            xytext=centerPt, textcoords='axes fraction',
                            va="top", ha="center", bbox=nodeType,
                            arrowprops=arrow_args)
    '''
    createPlot.ax1.annotate(str(nodeTxt).encode('utf-8').decode('utf-8'), xy=parentPt,
                            xycoords='axes fraction',
                            xytext=centerPt, textcoords='axes fraction',
                            va="top", ha="center", bbox=nodeType,
                            arrowprops=arrow_args,fontproperties=chinese_font)
...
def plotMidText(cntrPt, parentPt, txtString):
    ...
    createPlot.ax1.text(xMid, yMid, str(txtString).encode('utf-8').decode('utf-8'),fontproperties=chinese_font)
